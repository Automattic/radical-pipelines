...
The issue body _is_ the phase-0 prompt — `create-pipeline.md` turns the issue into `0-prompt/prompt.md`. So this is both the issue template and the prompt format. Render these sections and **omit any that are empty** — no `N/A` placeholders:
