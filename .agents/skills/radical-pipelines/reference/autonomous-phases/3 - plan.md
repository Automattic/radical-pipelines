...
| -------------------- | ---------------------------------------------------------------------------------------------------------- | ----------- |
| `code-plan-writer`   | Reads the spec and design doc, investigates the codebase, and writes `code-plan.md`.                       | No          |
...
| `doc-plan-writer`    | Reads the spec, design doc, and `code-plan.md`; writes `doc-plan.md` focused on what/where/who.            | No          |
...
1. Launch a fresh `code-plan-writer`. It reads `spec.md` and `design-doc.md`, explores the codebase as needed, and writes `code-plan.md`.
...
4. On **approved**, launch a fresh `doc-plan-writer`. It reads `spec.md`, `design-doc.md`, and the approved `code-plan.md`; explores the host project's existing documentation as needed; and writes `doc-plan.md`.
