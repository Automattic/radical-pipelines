(() => {
  ...
  const phases = [
    ...
    },
    {
      ...
      reads: ['design.md', 'spec.md'],
      writes: ['design-review-1.md'],
      runMs: 1000,
      sec: 47,
      tokens: '9.2k',
      treeIdx: [5],
    ...
    },
    {
      ...
      tokens: '64.1k',
      treeIdx: [8],
      bash: ['npm test', 'git commit -m "Add orchestrator (implementer)"'],
    },
    {
      phase: 'phase 4',
      task: 'implementer-reviewer',
      reads: ['src/orchestrator.ts', 'plan.md'],
      writes: ['code-review-1.md'],
      runMs: 1100,
      sec: 96,
      tokens: '14.3k',
      treeIdx: [9],
