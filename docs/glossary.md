...
- **Owner escalation** — The run's stop, with an evidence dossier, caused by a pending claim that targets the intent; the owner's answer is written into the intent as a decision.
