(() => {
  ...
  const phases = [
    ...
    },
    {
      ...
      writes: ['design-doc-review-r1-1.md'],
      runMs: 1000,
      sec: 47,
      tokens: '9.2k',
      treeIdx: [6],
    ...
    },
    {
      ...
      writes: ['build-plan-review-r1-1.md'],
      runMs: 900,
      sec: 38,
      tokens: '6.4k',
      treeIdx: [8],
    ...
    },
    {
      ...
      writes: ['build-review-r1-1.md', 'build-summary.md'],
      runMs: 1100,
      sec: 96,
      tokens: '14.3k',
      treeIdx: [10, 11],
    ...
    },
    {
      ...
      writes: ['document-plan-review-r1-1.md'],
      runMs: 850,
      sec: 33,
      tokens: '5.6k',
      treeIdx: [13],
    ...
    },
    {
      ...
      writes: ['document-review-r1-1.md', 'document-summary.md'],
      runMs: 800,
      sec: 31,
      tokens: '4.9k',
      treeIdx: [15, 16],
  ...
  const pendingTree = [
    ...
    '2-design-doc/design-doc-review-r1-1.md',
    '3-build/build-plan.md',
    '3-build/build-plan-review-r1-1.md',
    'src/orchestrator.ts + test',
    '3-build/build-review-r1-1.md',
    '3-build/build-summary.md',
    '4-document/document-plan.md',
    '4-document/document-plan-review-r1-1.md',
    'README.md, docs/',
    '4-document/document-review-r1-1.md',
