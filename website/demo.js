(() => {
  ...
  const phases = [
    ...
    },
    {
      ...
      writes: ['build-plan.md', 'tasks/task-1.md', 'tasks/task-2.md'],
      runMs: 1300,
      sec: 74,
      tokens: '11.7k',
      treeIdx: [7],
    ...
    },
    {
      ...
      then: { writes: ['tasks/task-1-report-1.md'], bash: ['git commit -m "Report task-1 attempt 1 (build-worker-tdd)"'] },
    },
    {
      phase: 'phase 3',
      task: 'build-reviewer',
      reads: ['src/orchestrator.ts', 'tasks/task-1-report-1.md', 'build-plan.md'],
    ...
    },
    {
      ...
      reads: ['tasks/task-1-report-1.md', 'spec.md'],
      writes: ['document-plan.md', 'tasks/task-1.md'],
      runMs: 1100,
      sec: 61,
      tokens: '9.4k',
      treeIdx: [12],
    },
    {
      ...
      reads: ['document-plan.md', 'tasks/task-1-report-1.md'],
    ...
    },
    {
      ...
      reads: ['tasks/task-1.md', 'README.md'],
      ...
      then: { writes: ['tasks/task-1-report-1.md'], bash: ['git commit -m "Report task-1 attempt 1 (document-worker)"'] },
    },
    {
      phase: 'phase 4',
      task: 'document-reviewer',
      reads: ['README.md', 'docs/orchestrator.md', 'tasks/task-1-report-1.md'],
