...
- Given an autonomous amend run, when the phase executes, then the plan loop produces `amend-plan-research.md`, `amend-plan.md`, and a terminating `amend-plan-review-approved.md`; the execution loop produces one commit per task, `amend-review-approved.md`, and `amend-summary.md`; and the gates run exactly once, in the final review.
