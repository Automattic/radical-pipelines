...
- `website/index.html` — the marketing site: meta description/keywords, the "runs in your CLI (Claude Code or Pi)" copy, the "Tooling caught up" line, and the one-line **Install** section (per-tool install blocks).
