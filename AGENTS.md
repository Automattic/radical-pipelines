...
- The skill must remain generic and must not contain any mention, even in examples, of things that are specific to any agentic coding tool, except in files specifically dedicated to documenting these tools and that the agent loads conditionally depending on the tool in question.
