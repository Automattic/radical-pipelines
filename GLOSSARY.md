...
- **Decision request** — the consolidator's route for a decision no lane made: a fresh lead scoped to the question researches, decides, and answers the consolidator directly; the consolidated record names the request as provenance.
