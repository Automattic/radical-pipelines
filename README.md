...
- An agent declares its own completion with `rp_request_termination`, which notifies its spawner once; every failed turn is announced to the spawner as well.
