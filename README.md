...
- phase agent profiles for the shipped phases and phase pairs: `spec-analyst`, `spec-researcher`, `spec-writer`, `spec-reviewer`, `spec-consolidator`, `design-doc-analyst`, `design-doc-researcher`, `design-doc-writer`, `design-doc-reviewer`, `code-plan-writer`, `code-plan-reviewer`, `docs-plan-writer`, `docs-plan-reviewer`, `code-writer`, `code-reviewer`, `docs-writer`, and `docs-reviewer` (phase 0 is the intent, an input rather than an agent-produced artifact, so it has no agent profile);
