...
Each launch has one mode: write the plan, or revise it from a rejection file. In revision mode, gather the context of step 1, read the current `document-plan.md` and the rejection, revise where the issues require, and keep the other tasks unchanged.
