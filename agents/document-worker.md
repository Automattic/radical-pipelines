...
- Document what the software does, as it is; host-project output — everything your task leaves outside the pipelines folder — references the software only, never the pipeline or its artifacts.
