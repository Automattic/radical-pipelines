...
4. Read the Required test commands section of `code-plan.md` — the floor your work must keep green.
...
1. Commit the tests using the host project's commit format. Group changes logically. Only commit when every gate and floor command passes.
