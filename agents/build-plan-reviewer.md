...
5. Read any existing `build-plan-review-*-rejected.md`. On a re-review, verify each prior issue's resolution and concentrate on the tasks the revision changed.
