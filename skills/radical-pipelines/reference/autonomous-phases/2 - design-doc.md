...
| Agent                     | Role                                                                                                                                                                                          |
| ------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `design-doc-lead`     | Drives the design Q&A, deciding on the researcher's evidence. Writes `design-doc-research.md` — every load-bearing claim carrying its check — and synthesizes `design-doc.md`. A fresh instance adjudicates each rejection. |
