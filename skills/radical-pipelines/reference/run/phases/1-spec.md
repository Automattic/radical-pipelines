...
- Every producer mode: `0-intent/intent.md`, `spec.md`, `spec-research.md`.
...
- Every review mode: `spec.md`, `spec-research.md`, and every file `spec.md` pins — intent, adjudicated challenges, lane inputs, and consolidation candidates. A wave adjudicating a challenge also receives its **Correction** or **Task report**.
