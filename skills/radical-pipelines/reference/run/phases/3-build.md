...
- Build review: the plan, its record and tasks, its **Pinned inputs** — the design doc and spec with their current approving reviews, every adjudicated challenge, and every production-lane input — every **Task report**, the **Challenge** or **Task report** under review when present, and materials per `../loop.md` § Review diffs.
