...
- Worker: the **Task** file, its **Dependencies**, **Write your report to**; on a later attempt, **Your previous report**, and the **Adjudication** when it adjudicated a failed one.
