...
- Worker: the **Task** file, its **Dependencies**, `1-spec/spec.md` and `2-design-doc/design-doc.md` (the rationale), the named **Existing documentation**, the project's **Documentation conventions**, and **Write your report to**; on a later attempt, **Your previous report**, the **Adjudication** when it adjudicated a failed one, and every **Review issue** attached to the task.
