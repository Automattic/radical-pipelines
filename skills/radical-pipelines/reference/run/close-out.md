...
The run stops: the target phase is complete, an owner escalation is pending, the owner cancelled, or something failed.
...
6. Report to the owner: pipeline, branch, pull requests, phases completed, constraints satisfied, proposals adopted or refuted, pending claims.
