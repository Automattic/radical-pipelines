...
This describes a prompt — whether a tracker issue body, a base prompt, or a review prompt. The prompt is the input to phase 1.
...
A vague idea yields just a Title and a Goal. That is a complete, valid prompt.
