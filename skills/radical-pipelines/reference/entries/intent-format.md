...
A re-synthesis from a modified issue also consumes the current intent: `Origin`, every decision, and every kept item keep their ids; a withdrawn item disappears; added content takes the next ids.
