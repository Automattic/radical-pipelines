...
```
Health tick for pipeline <pipeline slug> on branch <pipeline branch>, worktree <path>: run `<this skill's folder>/reference/conventions/health-monitoring.md` § Each tick.
```
