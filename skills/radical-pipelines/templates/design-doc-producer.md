# design-doc-producer — prompt template
...
<run-unique id, e.g. `design-doc-producer 31-2`> — sign your record entries with it;
...
<!-- Consolidate -->
- Lane candidates: <one line per lane: id — design doc path, record path>
