...
- **Assignee** — when starting work on a pipeline (creating, resuming, or forking), assign the Linear issue to the person running it: the current Linear user, found via the Linear MCP. Overwrite whoever was assigned before.
