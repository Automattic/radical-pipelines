...
This file holds the configuration for this project. The Conventions section (and a future Guardrails section) apply to every agentic coding tool used here; tool-specific guidance is documented in the reference files (`claude-code.md`, `pi.md`). Read the Conventions section plus the reference file for the active tool at the start of any workflow.
