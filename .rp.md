...
To find the Linear issue that mirrors a given GitHub issue, search Linear via the MCP for the GitHub issue URL — it lives in the Linear issue's description.
